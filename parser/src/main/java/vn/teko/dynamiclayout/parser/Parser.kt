...
class Parser {
    ...
    private fun startFetching(): List<Block> {
        ...
        val flashSaleBlock = FlashSaleBlock(flashSaleProducts, "Flash Sale")
        ...
        val bestSaleBlock = BestSaleBlock(bestSaleProducts, "Best Sales")
        ...
        products.add(RecentBlock(recentProducts, "Recent"))
